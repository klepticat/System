...
export default mod;
export const APIMessage = mod.APIMessage;
...
export const Speaking = mod.Speaking;
...
export const discordSort = mod.discordSort;
export const escapeMarkdown = mod.escapeMarkdown;
export const fetchRecommendedShards = mod.fetchRecommendedShards;
export const resolveColor = mod.resolveColor;
export const splitMessage = mod.splitMessage;
export const verifyString = mod.verifyString;
